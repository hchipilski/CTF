...
def plot_multivariate_update(Xa,Xa_density2d,Xa_JSdiv,Xa_me_EX,Xa_me_stdX,Xa_num_outside,\
    ...
    ax.set_xlabel(r'$\mathrm{z}_{1,k}$',labelpad=15,fontsize=fontsize)
    ax.set_ylabel(r'$\mathrm{z}_{2,k}$',labelpad=60,rotation=0,fontsize=fontsize)
...
#                 fontsize=26.0,y=1.1)
    ax_histx.set_title(r'$\mathbf{%s}$'%(filter_title),fontsize=fontsize+3,y=1.08)
