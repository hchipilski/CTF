...
"""
Multiple trial DA experiments with EnKF, QCEF and ECTF.
"""
...
def main():
    ...
    outdir_results = '/glade/scratch/hristoc/statistical_experiments/y_variations' # where filtering results are written
...
#                                 outdir_figures,seed_num,PDFu_x1,PDFu_x2)
    ...
    if do_plotting == 1:
        ...
        plot_multivariate_update(Xa_QCEF,Xa_density2d_QCEF,Xa_JSdiv_QCEF,Xa_me_EX_QCEF,\
                                 ...
                                 Xf,Ne,xt,y,EX1u,EX2u,PDFp,likelihood,PDFu_explicit,\
                                 x1_arr,x2_arr,edges_x1,edges_x2,'QCEF',RHOp,R[0][0],\
                                 outdir_figures,seed_num,PDFu_x1,PDFu_x2)
